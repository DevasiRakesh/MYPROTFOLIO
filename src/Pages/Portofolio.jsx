...
// Default certificate list (shown when Supabase is unavailable or empty)
const defaultCertificates = [
  { id: "default-1", Img: "/Coursera_certificate.pdf" },
  { id: "default-2", Img: "/Coursera_certificate2.pdf" },
  { id: "default-3", Img: "/Coursera_certificate3.pdf" },
...
const defaultProjects = [
  ...
  },
  {
    ...
    Description:
      "Created an AI-enhanced review aggregator using Tailwind CSS and JavaScript, integrating Gemini 2.0 Flash API for sentiment insights.",
    Link: "",
    Github: "https://github.com/kiranmukkamula",
  },
];
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const finalCertificates = certificateData.length
        ? certificateData
        : defaultCertificates;
      ...
      // Fallback: use default data so project detail still works
  ...
  const certificatesToShow = certificates.length ? certificates : defaultCertificates;
  const displayedProjects = showAllProjects ? projectsToShow : projectsToShow.slice(0, initialItems);
  const displayedCertificates = showAllCertificates ? certificatesToShow : certificatesToShow.slice(0, initialItems);
