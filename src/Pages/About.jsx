  ...
  const statsData = useMemo(() => [
    {
      ...
      value: totalProjects,
      label: "Data Projects",
      description: "Machine learning models & analyses",
    ...
    },
    {
      ...
      description: "Data Science & ML credentials",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      label: "Years in Data",
      description: "Analytics & ML journey",
      animation: "fade-left",
    },
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
        I am a Data Science enthusiast with a strong foundation in programming and analytics. 
I specialize in extracting meaningful insights from complex datasets and building machine learning models that solve real-world problems. My passion lies in transforming data into actionable intelligence.
                  </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Data is the new oil, but insights are the engine that drives innovation."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1hLLoA8soeYmGTumDQx64XQerRSpcCB8y/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
