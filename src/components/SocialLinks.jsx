...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/devasi-rakesh-424b9839b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rakesh_dewasi0008",
    icon: Instagram,
    url: "https://www.instagram.com/rakesh_dewasi0008/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@DevasiRakesh",
    icon: Github,
    url: "https://github.com/DevasiRakesh",
    color: "#ffffff",
