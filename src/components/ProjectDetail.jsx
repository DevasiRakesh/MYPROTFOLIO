...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/kiranmukkamula",
      };
      ...
      <div className="min-h-screen bg-[#030014] flex items-center justify-center px-4">
        <div className="text-center space-y-6">
          ...
          <p className="text-gray-300 max-w-md mx-auto">
            The project you are looking for is not available in the current portfolio data. It may not have been added yet,
            or the link may be outdated.
          </p>
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-indigo-600/20 text-indigo-100 border border-indigo-500/30 hover:bg-indigo-600/30 transition"
          >
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Devasi Rakesh</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Devasi Rakesh — Data Scientist.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Devasi Rakesh`}
        />
        <meta
